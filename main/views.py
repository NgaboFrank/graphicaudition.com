...
BASE_CONTEXT = {
    ...
    "packages": [
        {"name": "Starter Package", "price": "From $50", "items": ["1 custom flyer or social post", "Fast delivery", "1 revision"]},
        {"name": "Business Package", "price": "From $120", "items": ["Brand visuals for campaigns", "Multiple post designs", "2 revisions"]},
        {"name": "Premium Package", "price": "From $250", "items": ["Brand identity or website design", "Presentation mockups", "Priority support"]},
    ],
}
