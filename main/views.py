    ...
    "packages": [
        {
            ...
            "subtitle": "For brands that want a clean and confident first presentation.",
            "items": ["Logo support", "Social post design", "Flyer or poster layout"],
        },
        {
            "title": "Business Package",
            "subtitle": "For growing businesses that need stronger everyday design support.",
            "items": ["Campaign visuals", "Brand consistency", "Content-ready graphics"],
        },
        {
            "title": "Premium Package",
            "subtitle": "For businesses that want a full professional visual system.",
            "items": ["Website design", "Presentation mockups", "Complete creative direction"],
        },
    ],
    "portfolio": [
