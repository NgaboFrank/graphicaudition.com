...
BASE_CONTEXT = {
    ...
    "portfolio": [
        {"name": "Rooted Institute Data Analytics Training", "desc": "Training campaign visual design for a premium institutional brand.", "image": "main/images/rooted-institute-1.jpg"},
        {"name": "Rooted Institute Team Visual", "desc": "Clean educational campaign visual with a collaborative team presentation.", "image": "main/images/rooted-institute-2.jpg"},
        {"name": "Nova Skills Training Flyer", "desc": "Creative training flyer designed with a strong promotional layout.", "image": "main/images/nova-skills.jpg"},
